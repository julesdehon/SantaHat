...
//        navigationController?.pushViewController(uartViewController, animated: true)
        let cockpitViewController = storyboard.instantiateViewController(withIdentifier: "CockpitViewController") as! CockpitViewController
        
        cockpitViewController.peripheral = peripheral
        
        navigationController?.pushViewController(cockpitViewController, animated: true)
    }
